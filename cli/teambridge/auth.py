# 📄 Location: teambridge/cli/teambridge/auth.py
import os
import json
import socket
...
CONFIG_DIR = os.path.join(HOME_DIR, '.teambridge')
...
def save_local_context(team_code, project_name):
    ...
    local_dir = os.path.join(os.getcwd(), '.teambridge')
...
def load_local_context():
    ...
    local_path = os.path.join(os.getcwd(), '.teambridge', 'project_context.json')
